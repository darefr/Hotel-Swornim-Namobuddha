...
const themeScript = `(function(){try{var t=localStorage.getItem('htp-theme')||'dark';document.documentElement.classList.toggle('dark',t==='dark');}catch(e){document.documentElement.classList.add('dark');}})();`
